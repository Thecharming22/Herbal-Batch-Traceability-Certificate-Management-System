...
function About() {
  return (
    <section
      id="about"
      className="relative py-6 sm:py-20 px-4 sm:px-10 bg-gradient-to-b from-green-800 via-green-700 to-black text-white overflow-hidden"
    >
      {/* sparkle overlay */}
...
<div className="relative max-w-7xl mx-auto flex flex-row items-center gap-3 sm:gap-16">
        
        {/* IMAGE */}
     <div className="w-[38%] sm:w-[55%] flex-shrink-0">
        <img
  src={aboutImage}
...
/>
        ...
        {/* TEXT */}
<div className="w-[58%] sm:w-[45%] animate-slideUp text-left">
          <h2 className="text-lg sm:text-5xl font-extrabold mb-3 sm:mb-5 text-green-950 drop-shadow-lg animate-bounce">
            About Us
          </h2>

      <p className="text-[12px] sm:text-lg leading-5 sm:leading-relaxed text-green-100 animate-fadeIn">
        ...
        <p className="mt-2 sm:mt-4 text-[12px] sm:text-lg leading-5 sm:leading-relaxed text-green-200 animate-fadeIn delay-300">
